...
<!-- Top section for search form and Create New User button -->
<div class="container">
    <!-- Search Form -->
    <div class="search-container">
        <form action="{{ route('admin.users.index') }}" method="GET">
            <select name="column" class="search-select">
                ...
                <option value="mobile_number" {{ request('column') == 'mobile_number' ? 'selected' : '' }}>Mobile Number</option>
            </select>
            <input type="text" name="search" class="search-input" placeholder="Search users..." value="{{ request('search') }}" required>
            ...
            <tr>
                ...
                <td style="border: 1px solid black; padding: 15px; text-align: center;">
                    <div style="display: flex; gap: 10px; justify-content: center; align-items: center;">
                        <a href="{{ route('admin.users.edit', $user->id) }}" class="btn btn-warning" style="border: none; box-shadow: none;">Edit</a>
